...
function getcard() {
    ...
    cartArr.forEach(element => {
        ...
        // let numberOriginal = Number(element.price)
    ...
    if (sum >= 5000) {
        ...
        alltotal = (sum + 25);
        shipping_charges.innerText = `$${25}`;
        shipping_discount.innerText = "$00";
    } else if (sum == 0) {
        grand_total.innerText = "$00";
        all_total.innerText = "$00";
        shipping_charges.innerText = "$00";
        shipping_discount.innerText = "$00";
        tax.innerText = "$00"
    }
